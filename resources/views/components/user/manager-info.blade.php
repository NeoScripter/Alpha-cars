@props(['rating' => 4.5, 'name' => 'Кузьмина Анна', 'phone' => '+7 (926) 123-45-23', 'email' => 'admin@rolf.ru', 'image' => asset('images/png/avatar.jpeg'), "id"])
...
<div class="bg-[#FBFBFB] px-4 rounded-lg mx-auto sm:w-5/6 md:px-6 max-w-[1300px] overflow-hidden w-full">
    ...
    <div class="flex flex-col items-start gap-4 mb-4 sm:flex-row md:mb-3">
        ...
        <div class="self-end mt-6 ml-auto sm:mt-0">
            ...
            <a href="{{ route('user.manager', $id) }}" class="block ml-auto text-center text-gray-400 underline">Читать все
                отзывы</a>
        </div>
    </div>
</div>
